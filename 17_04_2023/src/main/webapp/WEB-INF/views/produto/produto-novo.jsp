		                ...
		                <div class="well">
							...
							<form:form modelAttribute="produtoModel" action="${contextPath}/produto" method="post">
		                        ...
		                        <div class="form-group">
									...
									<form:select path="categoriaModel.nomeCategoria" name="idCategoria" id="idCategoria">
								...
								<div class="form-group">
									...
									<form:select path="marcaModel.nome_marca" name="id_marca" id="id_marca">
										<form:options items="${marcas}" itemValue="id_marca" itemLabel="nome_marca"/>
									</form:select>
								</div>
