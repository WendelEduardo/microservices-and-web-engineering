		    	...
		    	<div> 
        			<div class="row">
            			<div class="col-md-12">
							...
							<a class="btn btn-secondary" href="${contextPath}/marca/form?page=marca-novo">Nova Marcas</a>
			...
			<thead>
			  ...
			  <c:forEach items="${marcas}" var="marca">
				    <tr>
				      ...
				      <td>
				      	  <form:form action="${contextPath}/marca/${marca.id_marca}" method="delete">
					          <a href="${contextPath}/marca/${marca.id_marca}"  class="btn btn-success btn-sm">Detalhes</a>
						      <a href="${contextPath}/marca/form?page=marca-editar&id=${marca.id_marca}"  class="btn btn-warning btn-sm">Editar</a>
