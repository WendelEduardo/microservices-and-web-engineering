	        ...
	        <div class="row">
	            <div class="col-lg-12">
	                <div class="well">
						...
						<form:form modelAttribute="marcaModel" action="${contextPath}/marca/${marcaModel.id_marca}" method="put">
							...
							<div class="form-group">
								<form:input type="hidden" path="id_marca" name="id_marca" id="id_marca" value="${marca.id_marca}" />
	                        </div>
							
							<div class="form-group">
								<label class="control-label" for="nome_marca">Nome da Marca:</label>
								<form:input type="text" name="nome_marca" path="nome_marca" id="nome_marca" value="${marca.nome_marca}" class="form-control" maxlength="50" size="50" />
	                       		<font color="red"><form:errors path="nome_marca" /></font><br/>
	                        </div>
							<hr>
