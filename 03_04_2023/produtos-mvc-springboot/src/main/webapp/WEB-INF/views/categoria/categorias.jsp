		    	...
		    	<div> 
        			<div class="row">
            			<div class="col-md-12">
							...
							<a class="btn btn-secondary" href="${contextPath}/categoria/form?page=produto-novo">Nova Categoria</a>
			  ...
			  <c:forEach items="${categorias}" var="categoria">
				    <tr>
				      ...
				      <form:form action="${contextPath}/categoria/${categoria.idCategoria}" method = "delete">
				          <a href="${contextPath}/categoria/${produto.idCategoria}"  class="btn btn-success btn-sm">Detalhes</a>
